// Fallback for when an image is invalid / fails to load
// Renders an invalid image icon
export default function FallbackImage() {
    return (
        <div className="flex items-center justify-center w-full h-full dark:bg-gray-700 bg-gray-300">
            <svg
                width="100px"
                height="100px"
